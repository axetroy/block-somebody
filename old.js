...
//显示控制面板
  function showPannle() {
    ...
    $('#view').toggle(function () {
      ...
      $('#block-keyWord').animate({"height": height}, {
        "end": function () {
          $(this).css({
            "height": height,
            "overflow-y": "auto"
  ...
  $(document).bind('click', function (e) {
    ...
    if ($(target).attr('data-field') && hasClass(target.parentNode, 'd_name') || $(target).attr('data-field') && hasClass(target.parentNode, 'tb_icon_author')) { //如果点到了名字上面
      (function (target) {
        ...
        $(confirmBox).animate({"top": "100", "opacity": "100"}, {
          "end": function () {
            clearTimeout(confirmBox.fadeOut);
            this.fadeOut = setTimeout(function () {
              $(confirmBox).animate({"top": "60", "opacity": "0"}, {
                "end": function () {
                  $(this).remove();
                }
              });
